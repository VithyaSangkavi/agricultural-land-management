        ...
        const fetchData = async () => {
            try {
                ...
                if (fromDate && toDate && lotId) {
                    ...
                    response = await axios.get(`http://localhost:8080/service/master/monthly-crop-report?startDate=${fromDate}&endDate=${toDate}&landId=${landId}`);
                    ...
                    // filter by landId
                    response = await axios.get(`http://localhost:8080/service/master/monthly-crop-report?landId=${landId}`);
